...
\begin{frame}[shrink=20]\frametitle{GAM Zusammenfassung: Stetiger räumlicher Effekt}
...
\begin{frame}[shrink=20]\frametitle{GAM Zusammenfassung: Diskreter räumlicher Effekt}
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}}lc} 
