...
\textbf{Variable} & \textbf{Anzahl Klassen} \\ \hline
\textcolor{blue}{Bewertung Wohngegend} &  \textcolor{blue}{6} \\ \hline
\textcolor{blue}{Meinung Stuttgart 21} &  \textcolor{blue}{6} \\ \hline
Personenanzahl im Haushalt & 5 \\ \hline
\textcolor{red}{Monatliches Netto Haushaltseinkommen} & \textcolor{red}{6} \\ \hline
Altersklasse Befragter & 6 \\ \hline
Geschlecht & 2 \\ \hline
Familiensatnd & 4 \\ \hline
Nationalität & 2 \\ \hline
Stadtbezirk & 23 \\ \hline 
Stadtteil &  142 \\ \hline 
Gauß-Krüger &   \\ \hline \hline
\end{tabular}
}
\end{table}
\end{frame}
