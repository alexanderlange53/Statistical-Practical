...
\begin{document}
<< include=F >>=
require(ggplot2);require(reshape2);require(colorspace) # package loading
...
Stich <- read.csv('/home/alex/Schreibtisch/Uni/statistisches_praktikum/Auswertung/Rohdaten/buergerumfrage/sample_aufbereitet.txt', 
                  header = T, sep = ';')
theme_set(theme_bw(20)) # Grafik theme
colo <- diverge_hsv(3)
source("/home/alex/Schreibtisch/Uni/statistisches_praktikum/Auswertung/Skripte/barplot")
@
...
\begin{frame}
<<echo=F, out.width='6cm', fig.align='center'>>=
barplot(Grund$Altersklasse, Stich$Altersklasse, Alterklasse)
@
\end{frame}
