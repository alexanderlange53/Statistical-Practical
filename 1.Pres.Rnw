...
Grund <- read.csv('/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Rohdaten/buergerumfrage/population_aufbereitet.txt', 
                    header = T, sep = ';')
Stich <- read.csv('/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Rohdaten/buergerumfrage/sample_aufbereitet.txt', 
                  header = T, sep = ';')
Grundz <- read.csv('/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Rohdaten/zensus/population_aufbereitet.txt', 
                  header = T, sep = ';')
Stichz <- read.csv('/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Rohdaten/zensus/sample_aufbereitet.txt', 
                  header = T, sep = ';')
bürg <- readOGR(dsn = "/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Geodaten/Buergerumfrage", layer = "buergerumfrage_stichprobe")  
b <- readOGR(dsn = "/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Geodaten/bezirke", layer = "bezirke")
pop <- readOGR(dsn = "/home/khusmann/mnt/U/Promotion/Kurse/Stat_Praktikum//Auswertung/Geodaten/Buergerumfrage", layer = "buergerumfrage_grundgesamtheit")  
...
\multicolumn{1}{l|}{Altersklasse} &  Ordinal & 18-25 & 30-35 & Kum. Logit\\ \hline
...
\multicolumn{1}{l|}{Haushaltsgröße} &  Ordinal  & 2 & 2 & \\ \hline
\multicolumn{1}{l|}{Wohndauer} & Ordinal  & $>$10 & $>$10 & \\ \hline
\multicolumn{1}{l|}{ALG II Quote} & Ordinal  & 4\% - 6\% & 4\% - 6\% & \\ \hline
\multicolumn{1}{l|}{Ein/Zweifamilienhäuser} & Ordinal  & 7 & 7 & \\ \hline
...
\multicolumn{1}{l|}{\textbf{Variable}} & \multicolumn{1}{c|}{\textbf{Skalenniveau}} & \multicolumn{2}{c|}{\textbf{Modus}}& \multicolumn{1}{c}{\textbf{Verteilung}} \\ 
\multicolumn{1}{l|}{} & \multicolumn{1}{c|}{} & G & S & \multicolumn{1}{l}{} \\ \hline
\multicolumn{1}{l|}{Altersklasse} &  Ordinal & 18-25 & 30-35 & \\ \hline
...
\multicolumn{1}{l|}{Haushaltsgröße} &  Ordinal  & 2 & 2 & Multinom. \\ \hline
\multicolumn{1}{l|}{Wohnfläche} & Ordinal  & 70 - $<$75 & 75 - $<$80 & \\ \hline
\multicolumn{1}{l|}{Stellung Beruf} & Nominal  & Selbstst. o. Beschäftigte & Angestellte & \\ \hline
\multicolumn{1}{l|}{Beamter} & Nominal & Nein & Nein & Binom./Pois.\\ \hline
\multicolumn{1}{l|}{Gebäudetyp} & Nominal & Mehrfamilienh. 3-6 W. & Mehrfamilienh. $>$13 W. & \\ \hline
\multicolumn{1}{l|}{Gebäudenutzung} & Nominal & Wohnzwecke vermietet & Wohnzwecke vermietet & \\ \hline
\multicolumn{1}{l|}{Gauß-Krüger X} &   &  & & \\ \hline 
...
\begin{itemize}
\item Logit Modell\\
$h(\eta)=\frac{exp(\eta)}{1+exp{\eta}}, $, logistic cdf
\item Probit Modell\\
$\Phi(\eta)=\int_{-\infty} ^ {\eta} \frac{1}{\sqrt{2 \pi}}exp(-\frac{1}{2}x^2) dx $, standard normal cdf
\item Komplementäres Log-Log Modell\\
$h(\eta)=1-exp(-exp(-\eta))$, extreme value cdf
...
\begin{itemize}
\item Multinomiales Logit Modell (sl. 106)\\
$P(y_i = 1)=\frac{exp(x_i'\beta)}{1+exp(x_i'\beta)}$, multinomial cdf
\item Kumulatives geordnetes Logit Modell (sl. 117) = Prop. Odds Modell\\
$P(y_i <= r)=\frac{exp(x_i'\beta)}{1+exp(x_i'\beta)}$, logistic cdf ??? 
\item Sequentielles Modell\\
$P(y_i = r | y_i < r) = F()$, any cfd F (sl. 120)
\end{itemize}

\end{frame}

\subsection{Geomodelle}
\begin{frame}
\begin{itemize}
\item Ordinal Kriging
$slide 88$
\item GMRF ,sl. 139
if regionalization in sub areas is necessary
\end{itemize}
...
\begin{itemize}
\item Penalised B Spline (Elmar slides)
\item Tensor Penalised B spline (Elmar slides)
- also possible: ordered, unordered,...
