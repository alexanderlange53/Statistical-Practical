...
\subsection{Modelle}
Über die schrittweise AIC Analyse wurde die geeignetste Kombination der sozioökonomischen Variablen ermittelt. Um die Einflüsse der räumlichen Effekte isoliert betrachten zu können, blieb die Kovariablenkombination innerhalb der Modelltypen gleich. In Tabelle \ref{stepAIC} werden demnach die räumlichen Effekte je Modelltyp (also \textit{Meinung zu Stuttgart 21 in drei Kategorien}, \textit{Meinung zu Stuttgart 21 in zwei Kategorien} und \textit{Bewertung der Wohnzufriedenheit}) für die gleichen, im Unterkapitel \textit{Schrittweiser AIC Vergleich} vorgestellten Kovariablenkombinationen dargestellt.\\
Für die Meinung zu Stuttgart 21 im dreikategorialen lässt sich erkennen, dass das Geoadditive Modell mit den kontinuierlichen Gauß-Krüger Informationen und den Stadtteil Informationen die höchste relative Qualität aufweist. Die diskrete Modellierung des räumlichen Effekts verbessert das dreikategoriale Modell nicht.
...
Zur Extrapolation der Meinung zu Stuttgart 21 wurden zunächst drei Modelle mit der dreikategorialer Response (\textit{Zustimmung}, \textit{Neutral} und \textit{Ablehnung}) und kontinuierlichem räumlichen Trend parametrisiert und verglichen. Eines mit räumlichem Effekt und sozioökonomischen Kovariablen, eines nur mit sozioökonomischen Kovariablen und eines nur mit dem räumlichen Effekt. Die geeignetste Kovariablenkombination wurde vorher über den schrittweisen AIC Vergleich. 
