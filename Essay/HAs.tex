...
\begin{table}[h] \centering 
  \caption{Parameter Meinung zu Stuttgart 21 mit 3 Klassen} 
  \label{} 
...
\hline \\[-1.8ex] 
 ...
 Constant & 0.000 & 0.000 & 0.000 \\ 
  ...
  & & & \\ 
\hline \\[-1.8ex] 
Observations & 3,062 & 3,062 & 3,093 \\ 
...
\begin{table}[!htbp] \centering 
  \caption{Parameter Meinung zu Stuttgart 21 mit 2 Klassen} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}}lccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\hline \\[-1.8ex] 
 ...
 s(Altersklasse.Befragter) & $***$ & $***$ & $**$ \\ 
  & & & \\ 
 Constant & $-$0.283$^{*}$ & $-$0.298$^{*}$ & 0.000 \\ 
  & (0.171) & (0.171) & (0.000) \\ 
  & & & \\ 
\hline \\[-1.8ex] 
Observations & 2,377 & 2,377 & 2,394 \\ 
...
\begin{table}[h] \centering 
  \caption{Parameter Bewertung der Wohngegend} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}}lccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\hline \\[-1.8ex] 
 ...
 s(Personenzahl.im.Haushalt) &  &  & $***$ \\ 
  & & & \\ 
 Constant & $-$0.339$^{***}$ & $-$0.357$^{***}$ & $-$0.271$^{*}$ \\ 
  & (0.084) & (0.083) & (0.143) \\ 
  & & & \\ 
\hline \\[-1.8ex] 
Observations & 3,127 & 3,127 & 3,398 \\ 
