...
\begin{figure}[htbp]
  \centering
  \subfigure[eins]{\includegraphics[scale=0.40]{Pictures/S21_3_Kont_SpatEff}}\quad
  \subfigure[zwei]{\includegraphics[scale=0.40]{Pictures/S21_3_Kont_SpatEff}}\quad
  \subfigure[drei]{\includegraphics[scale=0.40]{Pictures/S21_3_Kont_SpatEff}}
