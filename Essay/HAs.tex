...
Bei der genaueren Betrachtung der räumlichen Effekte der Meinung zu Stuttgart 21 (Abbildung \ref{rEffS21}) zeigt sich dann auch wie der räumliche Effekt auf die Ablehnungswahrscheinlichkeit wirkt. Es gibt einen klaren räumlichen Trend in den Daten, wenngleich dieser in Relation zu den sozioökonomischen Kovariablen relativ schwach ausgeprägten ist.
