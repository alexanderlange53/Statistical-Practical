...
Die letzte untersuchte räumliche Agrregation ist die Stadtteilebene. Abbildung \ref{SStuttgart21} zeigt die Verteilung der \textit{Zustimmungs} und \textit{Ablehnung}. Wie aus Tabelle \ref{Datensatz} hervorgeht,ist die Stadtteilebene deutlich feiner Aufgelöst als die Bezirksebene. Dies führt in der Abbildung dazu, dass in einzelnen Stadtteile mit einer geringen Gesamteinwohneranzahl keine Beobachtungen in einer Klasse oder mehreren Klassen auftauchen, die verbleibende Klasse somit zu 100 \% in dem Stadteil vertreten ist. Des weiteren gibt es sogar im Innenstadtbereich Stadtteile ohne jede Beobachtung, wie z. B. das Benzviertel.
...
Diese Stadtteile sind in allen drei Diagrammen schwarz eingefärbt. Wegen der feineren Auflösung ergibt sich ein mosaikartiges, schwerer interpretierbareres Bild der Anteilsverteilung in der Region. In keiner der drei Klassen lassen sich eine klare Struktur oder räumliche Muster beobachten. Die Anteile auf Stadtteileebene zu der Bewertung der Wohngegend sind im Anhang verfügbar \ref{SWohn}. Hier zeigt sich ein ähnlich schwer differenzierbares Muster wie bei der Meinung zu Stuttgart 21.\\

DEN ABSATZ HABE ICH ZUR DISK. VERSCHOBEN
...
\begin{figure}[h]
 ...
 \caption{Anteile der Bewertung der Wohngegend nach Stadtbezirken. Wegen der deutlichen unterschiede in den Anteilen sind die Farbskalen nicht einheitlich, sondern unterscheiden sich in den Diagrammen.}
 \label{BWohn}
 \end{center}
\end{figure}
